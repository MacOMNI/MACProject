...
+(NSString *)base64StringFromBase64UrlEncodedString:(NSString *)base64UrlEncodedString
{
    ...
    s = [s stringByReplacingOccurrencesOfString:@"%2F" withString:@"/"];
     s = [s stringByReplacingOccurrencesOfString:@"%2B" withString:@"+"];
    //DLog(@"base64UrlEncodedString %@",s);
...
{
    NSString *base64String=[MF_Base64Codec base64StringFromBase64UrlEncodedString:base64UrlEncodedString];
    //DLog(@"base64UrlEncodedString %@  base64String %@",base64UrlEncodedString,base64String);
    NSString *string=[self stringFromBase64String:base64String];
    if (![base64String isEqualToString:base64UrlEncodedString]) {
       // DLog(@"不一样");
    }
    return string;
}
