...
//    [UIView commitAnimations];
       [GCDQueue executeInMainQueue:^{
        ...
        [CoreAnimationEffect showAnimationType: @"fade"    withSubType:randomAnimationArr[rand()%randomAnimationArr.count] duration:2.0 timingFunction:kCAMediaTimingFunctionDefault view:_imageView];
