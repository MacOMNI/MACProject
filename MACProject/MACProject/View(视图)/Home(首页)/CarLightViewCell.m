...
- (void)awakeFromNib {
   ...
   // CSStickyHeaderFlowLayout *flowLayout=(CSStickyHeaderFlowLayout *)_collectionView.collectionViewLayout;
    ...
    [self.collectionView registerClass:[LightCell class] forCellWithReuseIdentifier:@"cell"];
    _titlesArray = @[@[@"安全带",@"车门提示",@"驱车制动",@"手刹",@"机油压力",@"左车门",@"主动转向",@"车盖没关"],@[@"防滑",@"后雾灯",@"预热",@"轮胎失压",@"清洗液",@"油量低",@"蓄电池",@"时速表"]];
    _imagesArray = @[@[@"light_anquan",@"light_chemen",@"light_quche",@"light_shousha",@"light_jiyou",@"light_zuoche",@"light_zhudong",@"light_chegai"],@[@"light_fanghua",@"light_houwu",@"light_yure",@"light_luntai",@"light_qingxi",@"light_youliang",@"light_xudianchi",@"light_shisu"]];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
            LightCell   *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
            // Configure the cell
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
            return CGSizeMake(self.width/4.0, (self.height-self.pageControl.height)/2.0-.5);
}
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView{
  ...
  //  CGFloat alpha=0;
    self.pageControl.currentPage=(int)(offsetX/self.width);
}
